...
An end-to-end forecasting project for Swiss electricity demand. It combines ENTSO-E load observations with Open-Meteo weather data, trains an LSTM forecaster, calibrates uncertainty from recent residuals, and shows the result through a Streamlit dashboard.
